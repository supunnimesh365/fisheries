...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        hero1: "url(/work/project-bg-dark.png)",
        ...
        work_project_bg_light: "url(/work/project-bg-light.jpg)",
        work_project_bg_dark: "url(/work/project-bg-dark.png)",
        contact_illustration_light: "url(/contact/illustration-light.jpg)",
        about_illustration_light: "url(/about/illustration-light.jpg)",
        careers_illustration_light: "url(/careers/illustration-light.jpg)",
